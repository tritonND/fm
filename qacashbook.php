        ...
        <div id="forBlocks" style="margin-left: 15px; margin-top: 25px; width: 95%; padding: 0px 10px">
           ...
           <div style="display: none;">
            ...
            <table id="myTable" class="table table-condensed table-striped table-bordered table-hover dt-responsive">
                ...
                $query1 = "SELECT * FROM fm_cashbook where status = 0 ORDER BY id";
                ...
                <?php while ($row = mysqli_fetch_array($result)) { ?>
                    <tr>
                        ...
                        <td style="width: 3% !important;">
                            ...
                            <button class="btn btn-sm trash" data-id="<?php echo $row[0];?>">
                                <i id='trashs' class='fa  fa-trash'></i>
                            </button>
                            <button class="btn btn-sm edit" data-id="<?php echo $row[0];?>" data-toggle="modal" data-target="#exampleModal">
                                <i id='edits' class='fa fa-edit'></i>
                            </button>
                        ...
                        <td><?php echo  "<p style='text-transform: uppercase;'>". $row[4] . "</p><b>". $row[5] . "</b>"; ?></td>
                        <td><?php echo  "<p style='text-transform: uppercase;'>". $row[3] . "</p><b>". $row[2] . "</b>"; ?></td>
                        <td><?php echo  "<p style='text-transform: uppercase;'>". $row[8] . "</p><b>". number_format($row[6],2) . "</b>"; ?></td>
                        ...
                        <td>
                            ...
                            if($row[15] == 0){
                                ...
                                <button class="btn btn-sm btn-secondary activate" data-id="<?php echo $row[15];?>" >
                                    Activate
                                </button>
