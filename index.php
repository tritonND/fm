...
<div class="collapse navbar-collapse" id="navbarTogglerDemo02"  style="margin-left: 5%; font-size: 20px;">
    ...
    <form class="form-inline my-2 my-lg-2" style="margin-right: 0%;">
      ...
      <!-- First Section -->
      <section class="top_section" style="background: #343752; display: none;">
        <div class="row no-gutters">

          <div class="col-md-6" style="background: #343752;color: rgb(241,243,245);">
            <div>
              <img class="img-fluid flex-shrink-1 align-self-sm-center" src="assets/img/arthometexy.png" style="margin-top: 75px;margin-left: 35px; width: 95%;">
            </div>
            <div class="text-left d-block d-sm-block flex-grow-1 flex-shrink-1 flex-sm-grow-1 flex-sm-shrink-1 flex-sm-fill flex-md-grow-0" style="margin-top: 7px;margin-left: -6px;text-align: left;">
              <button class="btn btn-primary flex-grow-1 flex-shrink-1 flex-sm-grow-1 flex-sm-shrink-1 flex-md-grow-1" type="button" style="margin-bottom: 0px;height: 35px;font-size: 16px;padding-top: 0px;padding-right: 3px;padding-bottom: 0px;padding-left: 4px;margin-top: 0px; margin-left: 20px;">Get the app</button>
            
            </div>
          </div>
          <div class="col-md-6">
            <div class="col top_col" style="background: #343752;color: rgb(241,243,245);">
              <img class="img-fluid" src="assets/img/homerightguy.png"></div>
 ...
 <!-- Start Copy of first Section -->
    <section class="top_section" style="background: #343752; padding-bottom: 25px;">
        <div class="row no-gutters">
            <div class="col text-left flex-shrink-1 flex-sm-shrink-1 top_col" style="background: #343752;color: rgb(241,243,245);">
                <div>
                  <img class="img-fluid flex-shrink-1 align-self-sm-center" src="assets/img/arthometexy.png" style="margin-top: 75px;margin-left: 30px; width: 95%;">
                </div>
                
          
                <div class="text-left d-block d-sm-block  flex-shrink-1  flex-sm-shrink-1 " style="margin-top: 7px;margin-left: -6px;text-align: left;">
                  <button class="btn btn-sm btn-primary flex-shrink-1" type="button" style="height: 29px;font-size: 16px;padding-top: 0px;padding-right: 3px;padding-bottom: 0px;padding-left: 4px;margin-top: 0px; margin-left: 20px;">Get the app</button>
                </div>
            </div>
            <div class="col top_col" style="background: #343752;color: rgb(241,243,245); margin-left: 5%;"><img class="img-fluid" src="assets/img/homerightguy.png" style="width: 85%;"></div>
        </div>
    </section>
    ...
    <section style="background: #c5d4f1; padding: 5%;">
      <!-- <div class="row no-gutters">  -->
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  <div class="row no-gutters">
                    ...
                    <div class="col-md-6">
                      <img class="d-block mx-auto img-fluid" style="width: 85%;" src="assets/img/phone1.png" alt="First slide">                
                    </div>
  
                    <div class="col-md-6">
                      <img class="d-block mx-auto img-fluid" style="width: 85%;" src="assets/img/sl1r.png" alt="First slide">
                      <!-- <button class="btn btn-sm btn-primary flex-shrink-1" type="button" style="height: 29px;font-size: 16px;padding-top: 0px;padding-right: 3px;padding-bottom: 0px;padding-left: 4px;margin-top: 0px; margin-left: 20px;">Get the app</button> -->
                      <button class="btn btn-dark flex-shrink-1" type="button" style="height: 45px;font-size: 18px;padding-top: 10px; padding-bottom: 10px;padding-right: 5px;padding-bottom: 10px;padding-left: 5px;margin-top: 0px; margin-left: 65px;">Get the app</button>
                ...
                <div class="carousel-item">
                    ...
                    <div class="row no-gutters">
                      ...
                      <div class="col-md-6">
                        <img class="d-block mx-auto img-fluid" style="width: 75%;" src="assets/img/phone1.png" alt="First slide">                
                      </div>
  ...
  <div style="text-align: center;"> 
    <span style="font-weight: bolder; font-size: 40px; padding-bottom: 0.5em;"> FM is loaded with free Accounting features</span> 
  </div>

      <div class="row no-gutters ">
        <div class="col-md-4" style="text-align: center;"> 
          <img width="51%" src="assets/img/budgetplanner.png">
          <p style="padding: 0% 20%;"> Say goodbye to spreadsheets with customizable budgets. Easily add and update your categories.</p>
        </div>

        <div class="col-md-4" style="text-align: center;"> 
          <img width="60%" src="assets/img/creditmonitor.png">
        ...
        <div class="col-md-4" style="text-align: center;"> 
          <img width="64%" src="assets/img/spendtrack.png">
      ...
      <div style="text-align: center; padding: 5% 0%;">
        <div class="row no-gutters">
          ...
          <div class="col-sm-8" style="margin-right: auto;"> 
            <img style="width: 520px;"  src="assets/img/yourfinance.png">
          </div>
          <div class="col-sm-2"> </div>
        ...
        <div style="margin-top: 15px;">
          <!-- <button class="btn btn-primary" type="button" style="background: url(&quot;assets/img/link.png&quot;) center / cover no-repeat, rgba(255,255,255,0);font-size: 21px;width: 202px;max-width: 202px;max-height: 55px;height: 150px;border-color: rgba(255,255,255,0);">
          </button> -->
