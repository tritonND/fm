...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-md-12">
        ...
        <div id="forBlocks" style="margin-left: 5px; margin-top: 25px; width: 60%;">
            ...
            <form id="createaccountform" autocomplete="off" method="POST" class="needs-validation" novalidate >
                <!-- Start Spinner -->
                ...
                <h3 style="margin-left: 7%;">Create Account</h3>
                <div class="form-group row" style="margin-bottom: 30px;">
                    <label for="fullname" class="col-sm-3 col-form-label">Account Name<small style="color:red;">*</small></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control imps" id="fullname" name="fullname" placeholder="" required>
                        <div class="invalid-feedback">Enter account name to be created </div>
                    </div>
                </div>
...
<script>
    ...
    $('#createaccountform').on("submit", function(submitEvent){
        ...
        if(! submitEvent.isDefaultPrevented()) {
            ...
            var x=$.ajax({
                url: "services/fmcreateaccount", // Url to which the request is send
            ...
            x.done(function(myresponse)
            {
                ...
                if(myresponse !== 'success'){
                    ...
                    setTimeout(function(){
                        location.href = "dashcreateaccount";
                    }, 2500);
