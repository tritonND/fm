...
$mysql = "UPDATE fm_mdausers set fullname = '$fullname', location = '$location', roles = '$roles', permissions = '$permissions' where username = '$username' ";

$result = mysqli_query($conn, $mysql);

if(mysqli_affected_rows($conn) >0){
    echo "success";
    audit_trail("MDA User Updated ". $useremail);
}
else {
    echo "fail";
}
