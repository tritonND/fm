...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-md-12">
        ...
        <section class="jumbotron text-center" style=" display: flex;  position: relative; align-items: center; margin-left: 2%; margin-right: 8%">
            <div class="col-4"></div>
        ...
        <div>
            ...
            <fieldset style="border: black;">
                <h6 style="margin-left: 2%">Upload files here</h6>
                <div class="jumbotron text-center" style="border: black ;display: flex;  position: relative; align-items: center; margin-left: 2%; margin-right: 8%">
                    <div class="col-2"></div>
                    <div class="col-8" align="center">

                            <div>
                                <input type="file" id="employee_file" name="employee_file"  style="display: none">
                                <a class="btn btn-primary" style="color: #fff" onclick="openFiles();return;">Select CSV File</a>
<!--                                <input type="file" name="employee_file" style="margin-top:15px;" />-->
                                <p id="filename" style="color: black;"></p>
                            </div>
...
<!--                    <input type="button" name="upload" id="upload" value="Upload" style="margin-top:10px;" class="btn btn-info" />-->
<!--                    <input type="submit" name="upload" id="upload" value="Upload" style="margin-top:10px;" class="btn btn-info" />-->
                    <button type="button" id="submits" class="btn btn-info">Upload</button>
                </div>
...
<script>
    ...
    function openFiles(){
        document.getElementById("employee_file").click();
    ...
    $(document).ready(function(){
        $('#submits').on("click", function(e){
            // console.log("clicked ", new FormData($('#upload_csv').get(0)));
            e.preventDefault(); //form will not submitted
            $.ajax({
                url:"services/importcsv",
                method:"POST",
                data:new FormData($('#upload_csv').get(0)),
